...
COPY --from=builder /opt/eo-frontend/build-xar/*.xar ${EXIST_HOME}/autodeploy/
COPY --from=builder /opt/edition-example/dist/*.xar ${EXIST_HOME}/autodeploy/
