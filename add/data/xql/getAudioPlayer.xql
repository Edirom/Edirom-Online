    ...
    <html>
        ...
        <body>
            ...
            <div
                ...
                <div
                    class="album-information"><span
                        amplitude-song-info="artist"></span> - <span
            ...
            <div
                ...
                <div
                    ...
                    class="hidden-on-expanded">
                    <div
                        id="small-player-middle-top">
                        <!-- Begin Controls Container -->
                        <div
                            id="small-player-middle-controls">
                            <div
                                class="amplitude-prev"
                                id="middle-top-previous"></div>
                            <div
                                class="amplitude-play-pause amplitude-paused"
                                amplitude-main-play-pause="true"
                                id="middle-top-play-pause"></div>
                            <div
                ...
                <div
                    ...
                    <div
                        id="toggle-playlist"
                        class="playlist-toggle"></div>
                    <span
                        class="current-time">
                        <span
                            class="amplitude-current-minutes"
                            amplitude-single-current-minutes="true">0</span>:<span
                ...
                <div
                    ...
                    class="hidden-on-collapse">
                    <div
                        id="toggle-playlist-full"
                        class="playlist-toggle"></div>
                    <div
                        id="small-player-full-bottom-controls">
                        <div
                            class="amplitude-prev"
                            id="middle-bottom-previous"></div>
                        <div
                            class="amplitude-play-pause amplitude-paused"
                            amplitude-main-play-pause="true"
                            id="small-player-bottom-play-pause"></div>
                        <div
                            class="amplitude-next"
                            id="middle-top-next"></div>
                    </div>
                    <div
                        id="small-player-full-bottom-info">
                        <span
                            class="current-time">
                            <span
                                class="amplitude-current-minutes"
                        ...
                        <span
                            ...
                            <span
                                ...
                                amplitude-single-duration-minutes="true">0</span>:<span
                                class="amplitude-duration-seconds"
                                amplitude-single-duration-seconds="true">00</span>
                        </span>
                    </div>
                </div>
            ...
            <div
                ...
                style="height:auto;max-height:590px;margin-bottom:18px;">
                <div
                    class="information">
                    {$artist} – {$album}
                    <hr/>
                    ...
                    return
                        ...
                        <div
                            ...
                            <div
                                class="playlist-meta">
                                <div
                                    class="now-playing-title">{$recTitle}</div>
                                <div
                                    class="album-information">{$artist} – {$album}</div>
                            </div>
                            <div
