    ...
    <div
            ...
            <div
                class="resps">
                {
                    ...
                    return
                        (
                        <div
                            class="label">{concat(upper-case(substring($resp/@role, 1, 1)), substring($resp/@role, 2))}</div>,
                        <div
                            class="name">{$resp/text()}</div>
                        )
                }
            </div>
                ...
                class="identifiers">
                {
                    ...
                    return
                        <div
                            class="identifier">
                            <div
                                class="label">{concat(upper-case(substring($ident/@type, 1, 1)), substring($ident/@type, 2))}</div>
                            <div
                                class="value">{$ident/text()}</div>
                        </div>
                }
            </div>
        ...
        <div
            class="expressions">
            {
                ...
                return
                    <div
                        class="manifestation">{$source//mei:source/mei:titleStmt/mei:title[1]/text()}</div>
                return
                    <div
                        class="expression"><h1>{$label}</h1><div
                            class="manifestations">{$manifestations}</div></div>
            }
        </div>
    </div>
};
            ...
            <div
                ...
                
                {
                    if ($doc//tei:titleStmt/tei:editor) then
                        ...
                        <div
                            ...
                            <div
                                class="key">{
                                    if (count($doc//tei:titleStmt/tei:editor) gt 1) then
                                        ('Herausgeber')
                                    else
                                        ('Herausgeber')
                                }</div>(:TODO: get keyValue:)
                            <div
                                class="value">
                                {$doc//tei:titleStmt/tei:title[@level eq 's']//text()}
                            </div>
                ...
                
                {
                    if ($doc//tei:sourceDesc/tei:msDesc//tei:repository) then
                        ...
                        (),
                    if ($doc//tei:sourceDesc/tei:msDesc//tei:idno) then
                        (
                        <div
                            class="library metaRow">
                            <div
                                class="key">Signatur</div>
                            <div
                                class="value">
                                {
                ...
                
                {
                    if ($doc//tei:publicationStmt/tei:publisher) then
                        ...
                        <div
                            ...
                            <div
                                class="value">{$doc//tei:publicationStmt/tei:publisher[1]/text()}</div>
                        </div>
                        )
                    else
                        ()
