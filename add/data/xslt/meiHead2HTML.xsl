        ...
        <xsl:element name="div">
            ...
            <xsl:element name="div">
                ...
                <xsl:if test="@unit and not(@unit eq '')">
                    <xsl:element name="span"><xsl:attribute name="class">unit</xsl:attribute> (<xsl:value-of select="eof:getLabel('classification')" />: <xsl:value-of select="mei:classification//mei:term" separator=", " />) </xsl:element>
                </xsl:if>
            </xsl:element>
            <xsl:element name="div">
        ...
        <xsl:element name="div">
            ...
            <xsl:element name="div">
                ...
                <xsl:if test="@xml:lang">
                    <xsl:element name="span"><xsl:attribute name="class">lang</xsl:attribute> (<xsl:value-of select="@xml:lang" />) </xsl:element>
                </xsl:if>
            </xsl:element>
            <xsl:element name="div">
                <xsl:attribute name="class" select="
...
<!-\\-          <xsl:with-param name="sub" select="true()"/>-\\->
    ...
    <xsl:template match="mei:dimensions" mode="plainCommaSep">
        ...
        <xsl:element name="div">
            ...
            <xsl:element name="div">
                ...
                <xsl:value-of select="eof:getLabel($key)" />
                <xsl:if test="@unit and not(@unit eq '')">
                    <xsl:element name="span"><xsl:attribute name="class">unit</xsl:attribute> (<xsl:value-of select="eof:getLabel('unit')" />: <xsl:value-of select="@unit" />) </xsl:element>
                </xsl:if>
            </xsl:element>
            <xsl:element name="span">
                <xsl:attribute name="class" select="string('subvalue')" />
    ...
    <xsl:template match="mei:extent" mode="plainCommaSep">
        ...
        <xsl:element name="div">
            ...
            <xsl:element name="div">
                ...
                <xsl:value-of select="eof:getLabel($key)" />
                <xsl:if test="@unit and not(@unit eq '')">
                    <xsl:element name="span"><!-- TODO: copy to TEI --><xsl:attribute name="class">unit</xsl:attribute> (<xsl:value-of select="eof:getLabel('unit')" />: <xsl:value-of select="@unit" />) </xsl:element>
                </xsl:if>
            </xsl:element>
            <xsl:element name="span">
                <xsl:attribute name="class" select="string('subvalue')" />
        ...
        <xsl:for-each select="./hand">
            <xsl:element name="div">
                ...
                <xsl:element name="div">
                    ...
                    <xsl:if test="matches(local-name(id(substring-after(@resp, '#'))), '(persName)|(name)|(corpName)')"> : <xsl:value-of select="id(substring-after(@resp, '#'))" />
                        <!-- TODO: Why does this select already the text within the element, but not the element itself??? --> </xsl:if>
                </xsl:element>
                <xsl:element name="div">
                    <xsl:attribute name="class">value</xsl:attribute>
                    <xsl:apply-templates select="node()" mode="valueOnly" />
    ...
    <xsl:template match="mei:rend" mode="#all">
        <xsl:variable name="style">
            ...
            <xsl:if test="@fontfam | @fontname"> font-family: '<xsl:value-of select="@fontfam | @fontname" />'; </xsl:if>
