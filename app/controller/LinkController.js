...
Ext.define('EdiromOnline.controller.LinkController', {
    ...
    loadLink: function(uri, cfg) {
        ...
        if(config['useExisting']) {
            var desktop = this.getApplication.getController('desktop.Desktop').getActiveDesktop();
        ...
        if(config['sort']) {
            ...
            if(config['sort'] == 'sortGrid')
                positions = this.getApplication.getController('desktop.Desktop').getGridPositioning(uriWindows.getCount() + i);
            
            if(config['sort'] == 'sortVertically')
                positions = this.getApplication.getController('desktop.Desktop').getVerticalPositioning(uriWindows.getCount() + i);

            if(config['sort'] == 'sortHorizontally')
                positions = this.getApplication.getController('desktop.Desktop').getHorizontalPositioning(uriWindows.getCount() + i);
    ...
    parseExistLink: function(uri, cfg) {
        ...
        return me.getApplication.getController('window.WindowController').createWindow(uri, cfg);
    },
