...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:eof="http://www.edirom.de/xslt/ediromOnlineFunctions" xmlns:functx="http://www.functx.com"
    exclude-result-prefixes="xs xd" version="2.0">
    <xd:doc scope="stylesheet">
        <xd:desc>
            <xd:p><xd:b>Created on:</xd:b> Mar 14, 2012</xd:p>
            <xd:p><xd:b>Author:</xd:b> bwb</xd:p>
            <xd:p>XSL-Module to include all global XSL:FUNCTIONs derived of the Edirom Online
                Project.</xd:p>
        </xd:desc>
    </xd:doc>
    ...
    <xsl:function name="eof:getLanguageString" as="xs:string">
        ...
        <xsl:value-of
            select="functx:replace-multi($languageFile//entry[@key = $key]/@value, for $i in (0 to (count($values) - 1)) return concat('\{',$i,'\}'), $values)"/>
