...
- `git checkout main`
- `git merge --no-ff rel/2.4.0` (release branch into main)
...
- upload the tested `Edirom-Online-2.4.0.xar` (asset)
- publish the release on Github
- `git checkout develop`
- `git merge --no-ff rel/2.4.0` (release branch into develop)
